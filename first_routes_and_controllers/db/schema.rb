...
ActiveRecord::Schema.define(version: 2021_11_11_211757) do
...
''
  create_table "collections", force: :cascade do |t|
    ...
    t.index ["name", "user_id", "artwork_id"], name: "index_collections_on_name_and_user_id_and_artwork_id", unique: true
